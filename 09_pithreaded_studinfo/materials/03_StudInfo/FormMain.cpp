    ...
    : dataAccess(&ui)
{
    ...
    connect(ui.buttonAddExam, SIGNAL(clicked()),
            this, SLOT(buttonAddExamClicked()));
    connect(ui.buttonRemoveExam, SIGNAL(clicked()),
            this, SLOT(buttonRemoveExamClicked()));
    connect(ui.buttonClearExams, SIGNAL(clicked()),
            this, SLOT(buttonClearExamsClicked()));
}
